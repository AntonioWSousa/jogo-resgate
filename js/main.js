function start() { // Inicio da função start()
  ...
  function energia() {
    ...
    if (energiaAtual == 0) {
      ...
      //Game Over
      //PS: Quando o jogo é executado em modo offline, é comum que, em algumas execuções, a imagem de fundo da div 'energia' oscile (pisque).
    }
